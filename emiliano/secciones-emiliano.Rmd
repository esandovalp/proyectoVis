...
ui <- navbarPage(
          ...
          div(
            ...
            div(
              ...
              div(
                ...
                actionLink("goto_section1", "Explorar →", class = "btn btn-primary")
              )
            ),
            ...
            div(
              ...
              div(
                ...
                actionLink("goto_section8", "Explorar →", class = "btn btn-primary")
              )
            ),
            ...
            div(
              ...
              div(
                ...
                actionLink("goto_section11", "Explorar →", class = "btn btn-primary")
              )
            ),
            
            # Section 12: Housing (Placeholder)
            div(
              class = "card",
              style = "width: 18rem; margin: 10px; opacity: 0.7;",
              div(
                class = "card-body",
                h5(class = "card-title", "12. Vivienda"),
                p(class = "card-text", "Análisis de condiciones de vivienda previas a la detención."),
                actionLink("goto_section12", "Próximamente →", class = "btn btn-secondary")
              )
            ),
            
            # Section 13: Housing Expectations (Placeholder)
            div(
              class = "card",
              style = "width: 18rem; margin: 10px; opacity: 0.7;",
              div(
                ...
                actionLink("goto_section13", "Próximamente →", class = "btn btn-secondary")
              )
            ),
            
            # Section 15: Criminal Records (Placeholder)
            div(
              class = "card",
              style = "width: 18rem; margin: 10px; opacity: 0.7;",
              div(
                class = "card-body",
                h5(class = "card-title", "15. Antecedentes Penales"),
                p(class = "card-text", "Análisis de historiales criminales previos."),
                actionLink("goto_section15", "Próximamente →", class = "btn btn-secondary")
              )
            )
          )
        )
  ...
  # Section 1: Family Background (Using existing code)
  ...
  # Section 8: Work History (Using existing code)
  tabPanel("Historial Laboral",
    titlePanel("Análisis de Empleo"),
    sidebarLayout(
      sidebarPanel(
        selectInput("work_filter", "Población:",
                   choices = c("all" = "all",
                             "women" = "women",
      ...
      mainPanel(
        tabsetPanel(
          tabPanel("Estado Laboral", plotOutput("status_plot")),
          tabPanel("Ocupaciones", plotOutput("occupations_plot")),
          tabPanel("Fuentes de Ingreso", plotOutput("income_plot"))
        )
      )
    )
  ),
  
  # Section 11: Education Access (Using existing code)
      ...
      sidebarPanel(
        selectInput("edu_population_filter", "Filtrar por:",
                   choices = c("Todos",
                             ...
                             "Mujeres Lengua Indígena",
                             "Mujeres Autoadscripción Indígena/Afro")),
        selectInput("edu_state_filter", "Estado:",
                   choices = "Campeche")
      ),
      mainPanel(
        tabsetPanel(
    ...
    fluidRow(
      column(12,
        div(
          ...
          h3("Sección en Desarrollo"),
          p("El análisis de condiciones de vivienda estará disponible próximamente.")
        )
      )
    )
  ),
    ...
    fluidRow(
      column(12,
        div(
          style = "text-align: center; padding: 50px;",
          h3("Sección en Desarrollo"),
          p("El análisis de expectativas de vivienda estará disponible próximamente.")
        )
      )
    )
  ),
  
  tabPanel("Antecedentes Penales",
    fluidRow(
      column(12,
        div(
          style = "text-align: center; padding: 50px;",
          h3("Sección en Desarrollo"),
          p("El análisis de antecedentes penales estará disponible próximamente.")
        )
      )
    )
  )
...
server <- function(input, output, session) {
  ...
  observeEvent(input$goto_section1, {
    updateNavbarPage(session, "Análisis del Sistema Penitenciario",
                    selected = "Antecedentes Familiares")
  })
  
  observeEvent(input$goto_section8, {
    updateNavbarPage(session, "Análisis del Sistema Penitenciario",
                    selected = "Historial Laboral")
  })
  
  observeEvent(input$goto_section11, {
    updateNavbarPage(session, "Análisis del Sistema Penitenciario",
                    selected = "Acceso a Educación")
  })
  
  # Implement existing server logic for sections 1, 8, and 11 here
  # [Previous server code for sections 1, 8, and 11 goes here]
  
  # Placeholder for future sections
  # [Server logic for sections 12, 13, and 15 will go here]
}
